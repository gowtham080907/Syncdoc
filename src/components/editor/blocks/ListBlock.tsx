...
export const ListBlock: React.FC<ListBlockProps> = React.memo(({
  ...
  return (
    <div className="flex items-start gap-3 py-1 px-1">
      <div className="mt-1.5 shrink-0 text-brand-400 select-none">
        {listType === 'number' ? (
      ...
      <div
        ...
        className="flex-1 outline-none text-slate-200 text-base leading-relaxed font-sans empty:before:content-[attr(data-placeholder)] empty:before:text-slate-600 empty:before:pointer-events-none rounded"

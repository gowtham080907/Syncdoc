...
export const HeadingBlock: React.FC<HeadingBlockProps> = React.memo(({
  ...
  const getHeadingStyles = () => {
    switch (headingLevel) {
      case 1:
        return 'text-2xl md:text-3xl font-black text-slate-900 tracking-tight py-2';
      case 2:
        return 'text-xl md:text-2xl font-extrabold text-slate-800 tracking-tight py-1.5';
      case 3:
        return 'text-lg font-bold text-blue-700 py-1';
    }
  };
  ...
  return (
    <Component
      ...
      className={`outline-none font-sans empty:before:content-[attr(data-placeholder)] empty:before:text-slate-400 empty:before:pointer-events-none px-1 rounded ${getHeadingStyles()}`}

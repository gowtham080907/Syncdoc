...
export const QuoteBlock: React.FC<QuoteBlockProps> = React.memo(({
  ...
  return (
    <div className="flex gap-3 my-2 pl-4 py-2 border-l-4 border-brand-500 bg-slate-900/50 rounded-r-xl">
      <Quote className="w-5 h-5 text-brand-400 shrink-0 mt-0.5" />
      <blockquote
        ...
        className="flex-1 outline-none text-slate-300 italic text-base leading-relaxed font-sans empty:before:content-[attr(data-placeholder)] empty:before:text-slate-600 empty:before:pointer-events-none"

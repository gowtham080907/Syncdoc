...
export const ParagraphBlock: React.FC<ParagraphBlockProps> = React.memo(({
  ...
  // Sync DOM content when block content prop changes from remote Yjs update
  useEffect(() => {
  ...
  return (
    <p
      ...
      className="outline-none text-slate-200 text-base leading-relaxed font-sans empty:before:content-[attr(data-placeholder)] empty:before:text-slate-600 empty:before:pointer-events-none py-1 px-1 transition-colors rounded"
